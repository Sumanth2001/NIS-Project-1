  ...
  <body>
    ...
    if($showSuccess){
        echo '<div class="container signup">
            <div class="alert alert-success alert-dismissible fade show" role="alert">
                <strong>'.$username.' has Successfully signed up!</strong> You can login now'.'
    ...
    ?>
        <div class="container">
            ...
            <form action="/ISAA/signup.php" method="post">
                <div class="mb-3 col-lg-6">
                    <label for="username" class="form-label">Username</label>
                    <input type="text" maxlength="50" class="form-control" id="username" name="username" placeholder="Username">
                </div>
                <div class="mb-3 col-lg-6">
                    <label for="email" class="form-label">Email address</label>
                    <input type="text" maxlength="50" class="form-control" id="email" name="email" placeholder="Email">
                </div>
                <div class="mb-3 col-lg-6">
